              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="relative">
                  ...
                  <div className={`p-3 border rounded-lg cursor-pointer text-center ${
                    ...
                    <div className="text-xs text-gray-500">Find professionals</div>
                  </div>
                </label>
                <label className="relative">
                  <input
                  ...
                  />
                  <div className={`p-3 border rounded-lg cursor-pointer text-center ${
                    selectedRole === UserRole.SERVICE_PROVIDER
                      ? 'border-primary-500 bg-primary-50 text-primary-700'
                      : 'border-gray-300 hover:border-gray-400'
                  }`}>
                    <div className="text-sm font-medium">Offer Services</div>
                    <div className="text-xs text-gray-500">Work as professional</div>
                  </div>
                </label>
              </div>
            </div>
